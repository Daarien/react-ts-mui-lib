...
import {
  ...
  Tooltip,
  Typography,
} from "src/components/TabScrollButton/node_modules/@material-ui/core";
import {
  withStyles,
  StyleRulesCallback,
  WithStyles,
...
} from "src/components/Button/node_modules/react-router-dom";
...
const TestOverride = React.forwardRef<HTMLDivElement, { x?: number }>(
...
const AvatarTest = () => (
  <div>
    ...
    <Avatar<"button">
      ...
      onClick={e => {
        expectType<React.MouseEvent<HTMLButtonElement, MouseEvent>, typeof e>(
          e
        );
        log(e);
      }}
...
const IconButtonTest = () => (
  <div>
    ...
    {() => {
      ...
      const ExtendedIconButton: React.FC<IconButtonProps<
        typeof ForwardedLink
      >> = props => <IconButton component={ForwardedLink} {...props} />;
      return (
        <ExtendedIconButton
          color="secondary"
      ...
      <div>
        <List>
          ...
          <ListItem
            ...
            onClick={e => {
              expectType<React.MouseEvent<HTMLLIElement, MouseEvent>, typeof e>(
                e
              );
              log(e);
            }}
  ...
  return (
    ...
    >
      ...
      <MenuItem<"a">
        ...
        onClick={e => {
          expectType<React.MouseEvent<HTMLAnchorElement, MouseEvent>, typeof e>(
            e
          );
          log(e);
        }}
            ...
            <TableRow>
              <TablePagination
                ...
                onChangeRowsPerPage={event =>
                  log({ rowsPerPage: event.target.value })
                }
              />
            </TableRow>
          </TableFooter>
...
const SelectTest = () => (
  <Select
    input={<Input />}
    value={10}
    onChange={e => log(e.currentTarget.value)}
  >
    <MenuItem value="">
      <em>None</em>
    </MenuItem>
