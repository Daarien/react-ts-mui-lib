...
import {
  ...
  makeStyles,
  styled,
} from "src/components/CssBaseline/node_modules/@material-ui/core/styles";
import { ThemeProvider } from "@material-ui/styles";
import Button from "src/components/Button/node_modules/@material-ui/core/Button";
import { blue } from "src/components/styles/node_modules/@material-ui/core/colors";
...
const StyledExampleOne = withStyles(
  styles
)(({ classes, text }: ComponentProps) => (
...
const ComponentWithChildren: React.FunctionComponent<WithStyles<
  typeof styles
...
const AnotherStyledSFC = withStyles({
  ...
  <div className={classes.root}>Stylish!</div>
));
...
}
{
  ...
  withStyles(styles)(
    // @ts-expect-error
    (
      props: Props & WithStyles<typeof styles> & { children?: React.ReactNode }
    ) => null
  );
...

{
  ...
  const ComponentWithThemeStyledWithTheme = styled(ComponentWithTheme)(
    styleWithTheme
  );
  ...
  const ComponentWithOptionalThemeStyledWithTheme = styled(
  ...
  <ComponentWithOptionalThemeStyledWithTheme
    value={1}
    theme={{ zIndex: { appBar: 100 } }}
  />;
}
...
function themeProviderTest() {
  ...
  <ThemeProvider<Theme>
    theme={{ props: { MuiAppBar: { "aria-atomic": "true" } } }}
  >
    {null}
  </ThemeProvider>;
}
