...
const DecoratedSFC = withStyles(styles)(
  ({ text, variant, color, classes }: Props) => (
...
const DecoratedNoProps = withStyles(styles)(
  class extends React.Component<WithStyles<typeof styles>> {
    render() {
      return (
        <Typography classes={this.props.classes}>Hello, World!</Typography>
      );
    }
  }
);
...
const sfcElem = (
  <DecoratedSFC text="Hello, World!" variant="h6" color="secondary" />
);
const classElem = (
  <DecoratedClass text="Hello, World!" variant="h6" color="secondary" />
);
...
const unionPropElem = (
  <DecoratedUnionProps category="book" author="Twain, Mark" />
);
