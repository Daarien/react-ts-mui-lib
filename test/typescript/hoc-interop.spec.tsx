...
import TextField, {
  TextFieldProps,
} from "src/components/TextField/node_modules/@material-ui/core/TextField";
...
// react-router
{
  ...
  const RouterTextField: React.FunctionComponent<RouterTextFieldProps> = () =>
    null;
...
// https://github.com/mui-org/material-ui/issues/14586
{
  ...
  // workaround
  const UnsafeStyledButton = withStyles({ root: { color: "ref" } })(
    Button
  ) as typeof Button;
